 ...
 * @LastEditTime: 2021-04-29 23:13:13
    ...
    <div class="analyse-info-top">
      ...
      <div class="analyse-info-top-blacklist analyse-info-top-items">
        ...
        <div class="analyse-info-title-wrap">
          ...
          <img
            src="../../assets/logo.png"
            class="analyse-info-title-top-icon"
          />
        ...
        >
          <span slot="suspectName" style="color: #363637" slot-scope="text">
            <!-- src="../../../assets/imgs/BlacklisIcon.png" -->
            <img
              src="../../assets/logo.png"
    ...
    <div class="analyse-info-bottom">
      <div class="analyse-info-bottom-suspects">
        ...
        <div class="analyse-info-title-wrap analyse-info-title-suspects-wrap">
          <!-- src="../../../assets/imgs/DataIcon-2.png" -->
          <img
            src="../../assets/logo.png"
...
// import groupCanvas from '@/components/graph/diagram/groupCanvas.vue';
// import {
//   blackList,
//   suspectForecastList,
...
export default {
      ...
      blackListColumns: [
        {
          ...
          scopedSlots: { customRender: 'suspectName' },
        },
        {
          title: '证件号码',
          dataIndex: 'idCard',
      ...
      columns_case: [
        {
          ...
          key: 'case_supi',
          className: 'title-class',
          scopedSlots: { customRender: 'case_supi' },
        },
        {
          title: '简要案情',
          dataIndex: 'simple',
  ...
  methods: {
    ...
    suspSubList() {
      ...
      suspectSubjectList(param).then((res) => {
      ...
      myChart.setOption({
        tooltip: {
          ...
          <div
            ...
            "
          >
            <span style="background: #F62157; display: inline-block; height: 6px; width: 6px; margin-right: 8px; border-radius: 50%;"></span>嫌疑主体分布
          </div>
          <div
            style="
