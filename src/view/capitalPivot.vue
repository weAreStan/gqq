      ...
      <div class="indes_sion">
        ...
        <div class="count">
          ...
          <a-select
            ...
            :size="size"
            placeholder="请选择（可多选）"
            style="width: 210px; height: 32px;overflow:auto"
            @change="count_handleChange"
          >
        ...
        <div class="average">
          ...
          <a-select
            ...
            :size="size"
            placeholder="请选择（可多选）"
            style="width: 200px; height: 32px;overflow:auto"
            @change="count_handleChange"
          >
            <a-select-option v-for="item in crLabel" :key="item.name">
              {{ item.name }}
